    ...
    with open(stab_path, 'r') as f:
        for line in f:
            ...
            if tokens[0] == 'Coef':
                ...
                col_aileron  = tokens.index('MainWing_SS_CONT_0')       if 'MainWing_SS_CONT_0'       in tokens else None
                col_elevator = tokens.index('HorizontalTail_SS_CONT_0') if 'HorizontalTail_SS_CONT_0' in tokens else None
                col_rudder   = tokens.index('VerticalTail_SS_CONT_0')   if 'VerticalTail_SS_CONT_0'   in tokens else None
                continue
